...
- Canonical tables used by the app now: profiles, teacher_profiles,
  upload-pdf, offer-teacher
- Legacy signup tables may still exist in the database, but the fixed
  login, profile, and teacher-directory flow no longer depends on them
